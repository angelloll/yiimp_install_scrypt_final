...
################################################################################
    ...
    php7.3-recode php7.3-sqlite3 php7.3-tidy php7.3-xmlrpc php7.3-xsl memcached php-memcache php-imagick php7.3-gettext php7.3-zip php7.3-mbstring \
    ...
    hide_output sudo apt -y update
    apt_install libdb5.3-dev libdb5.3++-dev libdb5.3 libdb5.3++
    echo -e "$GREEN Done...$COL_RESET"
