...
#
# Program:
#   Install yiimp on Ubuntu 16.04/18.04 running Nginx, MariaDB, and php8.2
...
################################################################################
    ...
    echo -e "$GREEN Install yiimp on Ubuntu 16.04/18.04 running Nginx, MariaDB, and php8.2 $COL_RESET"
    echo -e "$GREEN************************************************************************$COL_RESET"
    echo
    sleep 3
    ...
    sudo apt -y update
    sudo apt -y install libdb5.3-dev libdb5.3++-dev libdb5.3 libdb5.3++
    echo -e "$GREEN Done...$COL_RESET"
